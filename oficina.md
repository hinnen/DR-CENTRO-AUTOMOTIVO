...
**Rollback (31/08):** reverter commits `631b5ad` + `aa343f0` na `main` (ou `git revert` do merge) se demo/planilhas causarem problema — migrations `0002_is_demo` (accounts), `0003_is_demo` (customers/vehicles), `0005_is_demo` (workorders), `0001`/`0002` (core WorkshopSettings).

**Produção (31/08):** deploy autorizado Renan · push `631b5ad` → Render auto-deploy · hotfix localizações em seguida.
